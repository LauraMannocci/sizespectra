...
#ouput: fig_1_bruvs_screengrab.jpg, fig_2_sample.jpeg, Extended_data_length_weight.jpeg, fig_3_lat_lcd.jpeg, Extended_Data_Fig_lat_lcd_lon.jpeg
...
#ouput: size_response_pelagic.txt, size_response_benthic.txt, size_response_envar_pelagic_clean.txt, size_response_envar_benthic_clean.txt, pelagic_benthic_response_envar_clean.txt
